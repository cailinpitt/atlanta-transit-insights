// Post-text formatting helpers. Ported from cta-insights src/shared/format.js;
// the only MARTA change is the clock timezone (America/New_York).
...
// the minute; anything that rounds to 0 reads "on time". Returns null for a
// null/non-finite input so callers can simply omit the annotation.
