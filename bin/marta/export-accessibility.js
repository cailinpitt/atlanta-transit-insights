...
const { ACCESSIBILITY_ROLLOFF_MS, getAccessibilityOutages } = require('../../src/marta/storage');
...
function main(argv = process.argv.slice(2)) {
  const outPath =
    argv[0] || Path.join(__dirname, '..', '..', 'tmp', 'web-data', 'accessibility.json');
