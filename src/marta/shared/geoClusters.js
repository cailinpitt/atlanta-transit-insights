...
// Port of cta-insights src/shared/geoClusters.js.
//
...
// geographic: cluster raw lat/lon across all vehicles, then require the cluster
// to span 2+ routes/lines.
//
// Generic over any item exposing { lat, lon }; callers supply route/id accessors.
const { haversineFt } = require('../../shared/geo');

const DEFAULT_RADIUS_FT = 660; // an intersection + its approaches
