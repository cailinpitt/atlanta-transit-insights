// standard.site (https://standard.site) record publishing for the MARTA archive.
//
...
//     state feeds (see bin/marta/export-standard-site.js).
//
...
const SITE_BASE = 'https://atlantatransitalerts.app';
const PUBLICATION = {
  url: SITE_BASE,
  name: 'Atlanta Transit Alerts',
  description:
    'MARTA service alerts and bot-observed disruptions across rail, streetcar, and bus service.',
};

// Local state (server-side, gitignored alongside marta.sqlite). Records which
...
const STATE_PATH =
  process.env.MARTA_STANDARD_SITE_STATE ||
