...
> **Port in progress.** This repo is a fork-first port of [`cta-insights`](https://github.com/cailinpitt/cta-insights) targeting MARTA / Atlanta. CTA-specific adapters are being replaced with MARTA equivalents per `plan.md`. Much of the documentation below still describes the Chicago system and is being rebranded incrementally.

Bluesky bots that turn MARTA train and bus tracker data into Atlanta-specific transit visualizations.
